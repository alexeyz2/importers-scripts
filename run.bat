...
rem THIS IS THE NAME OF THE BUCKET, eg s3 -> s3://aline-build-output-p9  | minio -> http://127.0.0.1:9000/aline-build-output-p9
rem IN EITHER CASE THIS VARIABLE SHOULD BE SET AS "aline-build-output-p9"
