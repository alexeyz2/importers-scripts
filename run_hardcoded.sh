...
# dummy values to test start
export BASE_DIR=/opt/dfinstaller
export BUILD_PRODUCTID=1
export BUILD_PRODUCT_VERSIONID=2
export BUILD_JOBID=3
export BUILD_BUILDNUMBER=4
export ALINE_METAINF_JSON_FILE=$BASE_DIR/logs/metainf/metainf.json
export AWS_ACCESS_KEY_ID=AKIAJAI4Z6AJAVB7JHXQ
export AWS_SECRET_ACCESS_KEY=6wBPLYB66lZgE/dUgWY19DuObK9yQZffNx8A4nd8
# dummy values to test finish
...
# THIS IS THE NAME OF THE BUCKET, eg s3 -> s3://aline-build-output-p9  | minio -> http://127.0.0.1:9000/aline-build-output-p9
...
export MINIO_ACCESS_KEY="8P4XJ82BN1LPTMUCVR1Y"
export MINIO_SECRET_ACCESS_KEY="M31UrmDqoRjHq6PHumHcaILGNgykU/hi3GgfOZbD"
